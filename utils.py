...
#     else:
#         raise ValueError("Unsupported image shape: {}".format(img_shape))
...
def compare_ssim_(generated_img, label_img):
    ssim = measure.compare_ssim(generated_img, label_img)
    return ssim

def compare_psnr_(generated_img, label_img):
    psnr = measure.compare_psnr(generated_img, label_img)
    return psnr
